...
const StaveWithChord = (props: {
  ...
  w?: number
  h?: number
  notesList: { step: string, alter: number, octave: number }[]
}) => {
      ...
      'score-partwise': {
        ...
        'part': {
          ...
          'measure': {
            ...
            'note': generateChordNotes(props.notesList)
          }
        }
      }
    };
  ...
  }, [clef, keys, props.notesList]) // 确保依赖于 props.notesList
  ...
  useEffect(() => {
    renderRef().then()
  }, [renderRef, props]) // 确保依赖于 renderRef 和 props.notesList
